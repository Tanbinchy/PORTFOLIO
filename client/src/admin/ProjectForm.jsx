...
export default function ProjectForm() {
  ...
  return (
    <div
      className="min-h-screen text-white transition-colors duration-400"
      style={{ backgroundColor: isDark ? "#05050f" : "#eef2ff" }}
    >
                ...
                <label className="flex items-center justify-between cursor-pointer group">
                  <div>
                    <div className="flex items-center gap-2 text-white font-medium text-sm">
                      <HiBadgeCheck size={16} className="text-indigo-400" />{" "}
                      Featured Project
                    </div>
                    <div className="text-gray-600 text-xs mt-0.5">
                      Shown first in the projects grid
                    </div>
                  </div>
                  <div
                  ...
                  >
                    <div
                      className={`absolute top-0.5 w-5 h-5 rounded-full bg-white shadow transition-transform duration-300 ${form.featured ? "translate-x-5" : "translate-x-0.5"}`}
                    />
                  </div>
                </label>
              </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setMetric("stars", parseInt(e.target.value) || 0)
                      }
                      min={0}
                      className="glass-input w-full px-4 py-3 rounded-xl text-sm"
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setMetric("forks", parseInt(e.target.value) || 0)
                      }
                      min={0}
                      className="glass-input w-full px-4 py-3 rounded-xl text-sm"
                    />
